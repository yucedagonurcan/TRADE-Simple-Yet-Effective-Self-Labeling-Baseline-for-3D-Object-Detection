...
from kitti_oxts import roty, rotx, rotz
...
class Box3D:
    ...
    @classmethod
    def array2bbox_raw(cls, data, info):
    ...
    @classmethod
    def box2corners3d_lidarcoord(cls, bbox):
        ...
        if bbox.corners_3d_lidar is not None:
            return bbox.corners_3d_lidar
        ...
        bbox.corners_3d_lidar = corners_3d
